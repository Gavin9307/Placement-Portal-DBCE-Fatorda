...
CREATE TABLE `notifications` (
  ...
  `Dismiss_Notification` tinyint(1) DEFAULT 0,
...
CREATE TABLE `result` (
  `S_College_Email` varchar(255) NOT NULL,
  `Sem1_SGPA` decimal(4,2) DEFAULT NULL,
  `Sem2_SGPA` decimal(4,2) DEFAULT NULL,
  `Sem3_SGPA` decimal(4,2) DEFAULT NULL,
  `Sem4_SGPA` decimal(4,2) DEFAULT NULL,
  `Sem5_SGPA` decimal(4,2) DEFAULT NULL,
  `Sem6_SGPA` decimal(4,2) DEFAULT NULL,
  `Sem7_SGPA` decimal(4,2) DEFAULT NULL,
  `Sem8_SGPA` decimal(4,2) DEFAULT NULL,
  `CGPA` decimal(4,2) DEFAULT NULL,
  `has_backlogs` tinyint(1) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `student` (`S_College_Email`, `S_Fname`, `S_Mname`, `S_Lname`, `S_Personal_Email`, `S_Address`, `S_Phone_no`, `S_Roll_no`, `S_PR_No`, `S_10th_Perc`, `S_12th_Perc`, `S_Password`, `S_Resume`, `S_Profile_pic`, `S_10th_marksheet`, `S_12th_marksheet`, `S_Class_id`, `S_Year_of_Admission`) VALUES
('2114001@dbcegoa.ac.in', 'Aaron', NULL, 'Fernandes', 'afds@gmail.com', 'Margao Goa', '7878454784', '2114001', '2055452163', 95.00, 90.00, 'afds@123', 'aaron', 'fds', 'marsheet', 'mkssheet', 2, '2021'),
('2114018@dbcegoa.ac.in', '', NULL, '', '', '', '', '', '', 0.00, 0.00, '$2y$10$VVx4vjliUdYOpDfXB3t3SOZhckV97TdkJhnkZteEZOiXozJ7BM0Tu', NULL, NULL, NULL, NULL, NULL, NULL),
('2114033@dbcegoa.ac.in', 'Syndroy', 'Anthony', 'Colaco', 'patcolaco@gmail.com', 'Quelossim Goa', '7893268762', '2114033', '202150442', 97.22, 81.20, '$2y$10$yB2xT7I6BpxRw61IWU5qTOsOChISsAkpkaEzQHt/.ZArCw048Ce0q', NULL, '2114033.jpg', NULL, NULL, 2, '2021'),
('2114062@dbcegoa.ac.in', '', NULL, '', '', '', '', '', '', 0.00, 0.00, '$2y$10$w2kq7dEMIcnL0MEvxnaZEufMioXLFX4oMGEWLeTtQ7gcgsYJDuD5K', NULL, NULL, NULL, NULL, NULL, NULL),
('2114071@dbcegoa.ac.in', 'Sau', NULL, 'Siva', 'siva@gmail.com', 'Panjim Goa', '7845961502', '2214071', '2055452753', 85.00, 85.00, 'silv@123', 'siva', 'sau', 'marksheet', 'mkssheet', 4, '2021'),
('2214021@dbcegoa.ac.in', 'Luis', NULL, 'Bachan', 'luis@gmail.com', 'Fatorda Goa', '7845961203', '2214021', '2055452193', 96.00, 85.00, 'bach@123', 'luis', 'bachan', 'marksheet', 'mkssheet', 1, '2022'),
('2214051@dbcegoa.ac.in', 'Saul', NULL, 'Silva', 'silva@gmail.com', 'Vasco Goa', '7845961502', '2214051', '2055452753', 75.00, 95.00, 'silv@123', 'silva', 'saul', 'marksheet', 'mkssheet', 3, '2022'),
('araujo1@dbcegoa.ac.in', '', NULL, '', '', '', '', '', '', 0.00, 0.00, '$2y$10$xWUvRPb6psAXlHXTbFTxd.m8Pz.sb.MBrtTNf9NL4W3Ce2bbBTSka', NULL, NULL, NULL, NULL, NULL, NULL),
('araujo@dbcegoa.ac.in', '', NULL, '', '', '', '', '', '', 0.00, 0.00, '$2y$10$doOAdKAHGeeWzQHY5hpi9.0wfbBzbCDYBzLVgdq2udLkZF8BKw0zi', NULL, NULL, NULL, NULL, NULL, NULL);
...
ALTER TABLE `notifications`
  ADD PRIMARY KEY (`S_College_Email`,`PC_Email`),
  ADD KEY `PC_Email` (`PC_Email`);
...
--
ALTER TABLE `notifications`
  ADD CONSTRAINT `notifications_ibfk_1` FOREIGN KEY (`S_College_Email`) REFERENCES `student` (`S_College_Email`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `notifications_ibfk_2` FOREIGN KEY (`PC_Email`) REFERENCES `placementcoordinator` (`PC_Email`) ON DELETE CASCADE ON UPDATE CASCADE;
