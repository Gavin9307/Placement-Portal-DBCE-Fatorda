...
('2114008@dbcegoa.ac.in', 64, 0, '', '2024-08-14', 0),
...
('2114066@dbcegoa.ac.in', 64, 0, '', '2024-08-14', 0),
('2114078@dbcegoa.ac.in', 48, 0, '', '2024-08-07', 0),
('2114078@dbcegoa.ac.in', 53, 0, '', '2024-08-07', 0),
('2214077@dbcegoa.ac.in', 64, 0, '', '2024-08-14', 0);
...
(64, 'Associate Developer 2', 1, 'qq qqwed q3eqeqq qqdq', '2024-08-31', 324352, 10.00, 12, 1);
...
('warren@dbcegoa.ac.in', 2, 63, '2024-08-13'),
...
('2214077@dbcegoa.ac.in', 5.00, 6.00, 7.00, 4.00, 6.00, 0.00, 0.00, 0.00, 8.20, 0);
...
('2114066@dbcegoa.ac.in', 'Annaa', 'Carson', 'Townsend', 'anna@gmail.com', 'Quelossim Goa', '9307325976', '2114066', '202111382', 70.00, 90.00, '$2y$10$w5np0qZSADzFJjYlcpTIiOwqpl1LmXl8Kfb4KqjE5JOYN9IVuBQZC', 'ascac', 'Default_Profile_Pic.jpg', 'asca', 'scas', 2, '2021', 'F', 'No', 1),
...
('2214077@dbcegoa.ac.in', 'Akansha', '', 'Naik', 'akansha@gmail.com', 'Margao Goa', '9768758452', '2214077', '202211342', 80.00, 90.00, '$2y$10$O2pA3QDbcVtsSx2WJ2jQK.ZtbnKpxnJ87QcItXf7shxrK3DPb1RaS', '', '2214077.png', '', '', 1, '2022', 'F', 'No', 1);
...
('2114066@dbcegoa.ac.in', 12, 'passed'),
('2114066@dbcegoa.ac.in', 13, 'passed');
...
--
ALTER TABLE `jobplacements`
  MODIFY `J_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=65;
...
--
ALTER TABLE `jobquestions`
  MODIFY `JobQuestion_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
