            ...
            <div class="main-container">
                ...
                <div class="form-adjust">
                    <form action="" method="post">
                        <div class="inputbox">
                            ...
                            <input type="text" name="sname" placeholder="Add a question to the database ">
                        </div>
                ...
                <div class="sections">
                    <table>
                        ...
                        <tr>
                            <td>Do you have a pan card?</td>
                            <td><button class="edit-button">Edit</button></td>
                            <td><button class="remove-button">Remove</button></td>
                        </tr>
                        <tr>
                            <td>Do you have any relatives working in our company?</td>
                            <td><button class="edit-button">Edit</button></td>
                            <td><button class="remove-button">Remove</button></td>
                        </tr>
                    </table>
