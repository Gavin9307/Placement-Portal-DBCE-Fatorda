...
function createGoogleSheet($service, $sheetTitle, $companyName) {
    // Create a new spreadsheet
    $spreadsheet = new Sheets\Spreadsheet([
        'properties' => ['title' => $sheetTitle]
    ]);

    $spreadsheet = $service->spreadsheets->create($spreadsheet, ['fields' => 'spreadsheetId,sheets.properties']);
    $spreadsheetId = $spreadsheet->spreadsheetId;

    // Rename the first sheet to match the company name
...
$comapnyYear = "COMPANY 2024"; //add the company year

$spreadsheetId = createGoogleSheet($service, $comapnyYear,$companyName);
